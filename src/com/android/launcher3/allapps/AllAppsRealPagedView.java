 ...
 */
public class AllAppsRealPagedView extends PagedView<AllAppsSlidingTabStrip> {
    ...
    public AllAppsRealPagedView(Context context) {
        this(context, null);
    }

    public AllAppsRealPagedView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AllAppsRealPagedView(Context context, AttributeSet attrs, int defStyle) {
