 ...
 */
public class AllAppsSlidingTabStrip extends LinearLayout implements PageIndicator {
    ...
    public AllAppsSlidingTabStrip(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
